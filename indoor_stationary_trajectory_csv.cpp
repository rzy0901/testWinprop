...
int main()
{
    ...
    delete_file_path[0] = API_DATA_FOLDER "indoor_stationary_trajectory_csv/TX Power.fpp";
    delete_file_path[1] = API_DATA_FOLDER "indoor_stationary_trajectory_csv/TX Power.txt";
    delete_file_path[2] = API_DATA_FOLDER "indoor_stationary_trajectory_csv/TX Rays.ray";
//    double              PredictionHeight = 1.25;
    ...
    WinPropScenario.VectorDatabase = API_DATA_FOLDER "test_database/indoor_office_stationary.idb";
    ...
    if (Error == 0) {
        ...
        OutputResults.ResultPath = API_DATA_FOLDER "indoor_stationary_trajectory_csv"; // Output data directory
        ...
        char* filename = API_DATA_FOLDER "indoor_stationary_trajectory_csv/CIR.csv";
